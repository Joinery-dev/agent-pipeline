...
try {
  switch (command) {
    ...
    default:
      fail(`Unknown command: ${command}\n\nCommands: validate, update-project, add-major-phase, update-major-phase, get-major-phase, add-phase, add-task, get-task, get-phase, find-task, add-attempt, update-attempt, update-status, set-pipeline, rollup, rollup-major, rollup-all, get-state, check-deps, stale-tasks, add-diagram, add-illustration`);
  }
} catch (err) {
  fail(err.message);
}
